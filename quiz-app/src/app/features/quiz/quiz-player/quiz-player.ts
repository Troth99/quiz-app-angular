...
@Component({
  ...
  imports: [RouterLink, CommonModule, FormsModule, MatButtonModule, CommentsComponent],
...
ngOnInit(): void {
  ...
  this.quiz$ = this.quizService.getQuizById(this.categoryName, this.quizId).pipe(
